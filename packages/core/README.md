...
The schema-inference engine behind [`zod-crawler`](https://zodcrawler.figulus.dev/docs/#/cli). Give it
...
See the [docs site](https://zodcrawler.figulus.dev/docs/#/core-usage) for the
