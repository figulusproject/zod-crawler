...
// A delay below this is rejected outright rather than silently allowed - protects against accidentally (or deliberately) hammering a target with no pacing at all.
